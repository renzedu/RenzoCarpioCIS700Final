...
$(document).ready(function () {
    ...
    function mp_GetData() {
        $.ajax({
            type: "POST",
            url: "SQLQuery.aspx/GetDataTable",
            contentType: "application/json; charset=utf-8",
            dataType: "json",
            error: function (jqXHR, sStatus, sErrorThrown) {
                alert('data:  ' + sErrorThrown);
            ...
            success: function (data) {
                ...
                for (i = 0; i <= oTable.Rows.length - 1; i++) {
                    ...
                    datasetResultsObject.push({
                        id: oTable.Rows[i].lTaskID,
                        name: oTable.Rows[i].sDescription
                    });
    ...
    function init() {
        ...
        //getImageInterval = setInterval(function () { getImage(); }, 10000);
